"""Router GET /api/v1/estados-lote

Catálogo de estados de lote. Solo consulta.
...
from app.schemas.catalogo_produccion import EstadoLoteCatalogoOut
...
@router.get("/", response_model=list[EstadoLoteCatalogoOut])
def listar(
    ...
    return svc.listar_estados_lote(db, solo_activos=solo_activos)
