"""Router GET /api/v1/etapas-productivas

Catálogo de etapas del ciclo. Solo consulta.
...
from app.schemas.catalogo_produccion import EtapaProductivaCatalogoOut
...
@router.get("/", response_model=list[EtapaProductivaCatalogoOut])
def listar(
    ...
    return svc.listar_etapas_productivas(db, solo_activos=solo_activos)
