...
def main() -> int:
    ...
    igual("ganancia de biomasa", dec(data["productividad"]["ganancia_biomasa_kg"]), Decimal("30.400"))
    ...
    igual("FCA congelado", dec(data["eficiencia"]["fca"]), Decimal("0.2961"))
    ...
    igual("comparativo reutiliza FCA", dec(comparativo["estanques"][0]["eficiencia"]["fca"]), Decimal("0.2961"))
