...
const page = <T extends object>(loader: () => Promise<T>, name: keyof T) => lazy(() => loader().then((module) => ({ default: module[name] as ComponentType })));
...
const CostosLotePage = page(() => import("./pages/produccion/CostosLotePage"), "CostosLotePage");
    ...
    <Suspense fallback={<LoadingState label="Cargando módulo…" />}>
      <Routes>
        ...
        <Route element={<RequireAuth><AppLayout /></RequireAuth>}>
          ...
          <Route path="/produccion/lotes/:id/costos" element={<CostosLotePage />} />
          ...
          <Route path="/admin/usuarios" element={<RequireRole roles={["ADMINISTRADOR"]}><UsuariosPage /></RequireRole>} />
